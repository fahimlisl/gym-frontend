...
export const fetchAllMembers = () => api.get("/admin/fetchAllUser");
...
export const registerMember = (formData) => {
  return api.post("/admin/registerUser", formData, {
    headers: {
...
export const deleteTrainer = (id) => api.delete(`/admin/destroy-trainer/${id}`);

export const fetchAllTransactions = () =>
  api.get("/admin/fetchAllTransactions");

export const calculateTotalInLet = () => api.get("/admin/calculateTotalInLet");

// revenew part
export const fetchDashboardRevenue = () => api.get("/admin/dashboard-revenue");

export const fetchRevenueBySource = () => api.get("/admin/revenue-by-source");

export const fetchRecentTransactions = () =>
  api.get("/admin/recent-transactions");

// cafe
export const fetchAllCafeItem = () => api.get("/admin/fetchAllCafeItem");

export const destroyCafeItem = (id) => api.delete(`/admin/destroy-item/${id}`);

export const editCafeItem = (id, data) =>
  api.post(`/admin/edit-item/${id}`, data);

export const addCafeItem = (formData) => api.post("/admin/add-item", formData);

export const toggleCafeItemAvailability = (id) =>
  api.patch(`/admin/toggleAvailability/${id}`);

// cafe admin staff
export const addCafeAdmin = (data) => api.post("/admin/add-cafe-admin", data);

export const fetchAllCafeAdmin = () => api.get("/admin/fetchAllCafeAdmin");
...
export const addBenefit = (id, data) =>
  api.patch(`/admin/plan/add/benefit/${id}`, data);
...
// Diet management
export const generateDiet = (userId, formData) =>
  api.post("/admin/diet/generate", formData, {
    headers: { "Content-Type": "multipart/form-data" },
  });

export const editDiet = (dietId, formData) =>
  api.patch(`/admin/diet/edit/${dietId}`, formData, {
    headers: { "Content-Type": "multipart/form-data" },
  });

export const approveDiet = (dietId) =>
  api.patch(`/admin/diet/approve/${dietId}`, { status: "approved" });

export const checkDietExists = (userId) =>
  api.get(`/admin/diet/check/${userId}`);

export const showParticularDiet = (userId) =>
  api.get(`/admin/diet/show/${userId}`);
