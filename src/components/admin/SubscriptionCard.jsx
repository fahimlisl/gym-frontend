    ...
    <>
      <div className="border border-red-600/30 bg-black p-6 rounded-xl space-y-6">
        <div className="flex items-center justify-between">
          ...
          <button
            onClick={() => isSuperAdmin && setChangeDateOpen(true)}
        ...
        <div className="border border-red-600/40 bg-neutral-950 p-4 rounded-lg space-y-2">
          ...
          {current.discountType !== "none" && (
            <Row label="Discount" value={current.discount.amount} />
          )}
          ...
          <button
            ...
            disabled={isActive}
            className={`w-full mt-4 border border-red-600 py-3 font-extrabold tracking-widest transition
        ...
        {subs.length > 1 && (
          <div className="space-y-3">
            <p className="text-xs tracking-widest text-gray-400">SUBSCRIPTION HISTORY</p>
            {[...subs]
              .slice(0, -1)
              .reverse()
              .map((s) => {
                ...
                return (
                  <div key={s._id} className="border border-white/10 bg-neutral-900 p-4 rounded-lg">
                    ...
                    <div className="text-xs text-gray-400 mt-2 space-y-1">
                      ...
                      {s.discountType !== "none" && <p>Discount: {s.discount.amount}</p>}
                      {isFirstEver && (
                        <>
