...
export default function RenewPTModal({
  ...
  const submit = async (e) => {
    ...
    try {
      ...
      await api.post(
        `/admin/personal-training-renewal/${userId}/${trainerId}/${selectedPlan._id}`,
        formData
      );
      ...
      toast.error(err?.response?.data?.message || "Failed to renew PT");
    } finally {
      setLoading(false);
    }
  };
