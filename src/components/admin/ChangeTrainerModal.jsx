...
export default function ChangeTrainerModal({ userId, currentTrainerId, onClose, onSuccess }) {
  ...
  const loadTrainers = async () => {
    try {
      ...
      // exclude the currently assigned trainer
                ...
                {trainers.map((trainer) => (
                  ...
                  >
                    <img
                      ...
                      className="w-12 h-12 rounded-full object-cover border-2 border-red-600/40 flex-shrink-0"
                    />
                    <div className="flex-1 min-w-0">
                      <p className="font-extrabold text-sm tracking-wide text-white truncate">
