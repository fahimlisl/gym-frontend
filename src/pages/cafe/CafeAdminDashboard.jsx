                ...
                {filteredBarcodes.map((item) => (
                  ...
                  >
                    ...
                    <span className="text-sm text-gray-500">
                      {item.name} :{" "}
                      <span
                        className={`text-sm ${item.quantity < 5 ? "text-red-500 font-semibold" : ""}`}
                      >
                        stock - {item.quantity} {item.quantity < 5 && "(Low)"}
                      </span>
                    </span>
                  </div>
                ))}
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
            {items.map((i) => (
              ...
              >
                ...
                <p
                  className={`text-sm ${i.quantity < 5 ? "text-red-500 font-semibold" : ""}`}
                >
                  stock - {i.quantity} {i.quantity < 5 && "(Low)"}
                </p>
              </div>
            ))}
          </div>
