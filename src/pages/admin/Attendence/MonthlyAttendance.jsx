        ...
        <table className="border-collapse text-xs w-full">
          <thead>
            <tr>
              ...
              <th className="px-3 py-2 border border-[#1f1f1f] text-gray-400">
                Present
              </th>
            ...
            {members.map((m) => {
              ...
              return (
                ...
                >
                  ...
                  <td
                    className={`text-center border border-[#1f1f1f] font-semibold ${
                      isCritical
                        ? "text-red-400"
                        : "text-gray-300"
                    }`}
                  ...
                  <td
                    className={`text-center border border-[#1f1f1f] font-bold ${
                      isBelow50
                        ? "text-red-500"
                        : "text-green-500"
                    }`}
